...
HLApplication::HLApplication(int &argc, char *argv[], const QString uniqueKey)
...
bool HLApplication::isRunning()
{
    return _isRunning;

}

bool HLApplication::sendMessage(const QString &message)
{
    if (!_isRunning)
        return false;
...
void HLApplication::receiveMessage()
{
